...
stoneImage.src = "brick1.png";
let key= new Image();
key.src="key.png";
let start= new Image();
start.src="start.png"
let obstacle=new Image();
obstacle.src="stone.png"
let skeletonUp=new Image();
skeletonUp.src="skeletonUp.png"
let skeletonDown=new Image();
skeletonDown.src="skeletonDown.png"
let skeletonLeft=new Image();
skeletonLeft.src="skeletonLeft.png"
let skeletonRight=new Image();
skeletonRight.src="skeletonRight.png"
let keyPrize=new Image();
keyPrize.src="keyPrize.png"
let openChest=new Image();
openChest.src="chestopen.png"
let closeChest=new Image();
closeChest.src="chestclose.png"
let ctx;
...
function preload()
{
    stepSound=new Audio("effect/move.mp3")
    pickSound=new Audio("effect/pick.mp3")
}
let a,b,c;
